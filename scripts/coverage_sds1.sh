...
ref=/pub/adamsed/bwa.ref/SDS1.fasta
...
| samtools view -bS - \
| samtools sort - -o $output/${prefix}_sds1_sort.bam

samtools index $output/${prefix}_sds1_sort.bam
...
-b $output/${prefix}_sds1_sort.bam \
-o $output/${prefix}_sds1.bw \
-bs 1
