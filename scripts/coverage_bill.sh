...
# define directories
dirlist=data/processed/dir_s.txt
files=data/processed/sis.txt
ref=/pub/adamsed/bwa.ref/Bill.fasta
...
| samtools view -bS - \
| samtools sort - -o $output/${prefix}_bill_sort.bam

samtools index $output/${prefix}_bill_sort.bam
...
-b $output/${prefix}_bill_sort.bam \
-o $output/${prefix}_bill.bw \
-bs 1
