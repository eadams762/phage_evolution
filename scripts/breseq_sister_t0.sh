...
#SBATCH --job-name=breseq_S_t0		## job name
...
#SBATCH --array=1-3			## number of array tasks
...
rm -rf $output/${prefix}/07_error_calibration/
rm -rf $output/${prefix}/08_mutation_identification/
rm -rf $output/${prefix}/output/calibration/
