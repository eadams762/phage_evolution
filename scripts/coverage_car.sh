...
ref=/pub/adamsed/bwa.ref/Car.fasta
...
| samtools view -bS - \
| samtools sort - -o $output/${prefix}_car_sort.bam

samtools index $output/${prefix}_car_sort.bam
...
-b $output/${prefix}_car_sort.bam \
-o $output/${prefix}_car.bw \
-bs 1
